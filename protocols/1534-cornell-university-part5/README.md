# High Throughput leChRO-seq Day 3-A: 2nd Bead Wash and Enrichment
...
This protocol follows Day 3 part 1 of the High Throughput leChRO-seq protocol (steps 140-175).
...
After this part of the protocol is done, you need to perform the steps describe in the protocol manually (steps 176-193) before moving on to the next part of the protocol.
