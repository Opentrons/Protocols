...
* `Number of Sample Columns`: Specify the number of columns that contains samples (Min: 1, Max: 24).
...
### Deck Setup
![deck layout](https://opentrons-protocol-library-website.s3.amazonaws.com/custom-README-images/5520f0/5520f0.png)
...
![reservoir 2](https://opentrons-protocol-library-website.s3.amazonaws.com/custom-README-images/5520f0/reagent_reservoir.png)
