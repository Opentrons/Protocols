...
def run(ctx):
    ...
    # labware setup
    tuberack_1 = ctx.load_labware("opentrons_10_tuberack_nest_4x50ml"
                                  "_6x15ml_conical",
                                  '1')
    tuberack_4 = ctx.load_labware('opentrons_24_tuberack_eppendorf'
                                  '_2ml_safelock_snapcap', '4')
    deep_plates = [ctx.load_labware("plateone-96-deep-well-plate-2ml", slot)
                   for slot in ['5', '6']]

    tiprack_1000 = ctx.load_labware('tiprack-1000ul', '2')
    tipracks_300 = [ctx.load_labware('opentrons-tiprack-300ul', slot)
                    for slot in ['3', '7']]
