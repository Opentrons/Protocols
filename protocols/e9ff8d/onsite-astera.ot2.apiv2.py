...
def get_values(*names):
    import json
    _all_values = json.loads("""{ "num_samp":1,
...
def run(ctx):
    ...
    strip_tube_plate = ctx.load_labware('eppendorf_96_wellplate_200ul', 1,
                                        "SAMPLE PLATE")
    ...
    for sample in samples:
        ...
        p300.dispense(125+preairgap, sample.top(z=-5), rate=0.2)
        p300.blow_out()
        p300.drop_tip()
