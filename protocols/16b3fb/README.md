...
## Description
This protocol performs a custom tube filling protoocl for up to 432 custom tubes per run.
...
### Deck Setup
![deck](https://opentrons-protocol-library-website.s3.amazonaws.com/custom-README-images/16b3fb/deck.png)
