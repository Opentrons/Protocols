# NGS Library Prep Part 4/4: M6 PCR Cleanup
...
## Process
1. Input the number of samples to be processed, pipette mount sides, whether dual indexes will be used, and reagent starting column.
