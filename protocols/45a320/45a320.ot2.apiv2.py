...
def run(ctx):
    ...
    ctx.pause('''
            ...
            water to be added to these empty tubes on the left side of the
            tube rack. The protocol on the OT-2 is completed after the
            water is added.
            ''')
    ...
    airgap = 5
    col_counter = 0
    for i, elute in enumerate(final_tubes_pt1[:num_samp]):
