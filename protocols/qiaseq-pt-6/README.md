# QIAseq Targeted DNA Panel for Illumina Instruments Part 6: Universal PCR
...
## Description
This protocol performs QIAseq Targeted DNA Panel for Illumina Instruments Part 6: Universal PCR.
...
reagent tuberack: slot 2
* A1: UPCR buffer
* B1: DNA polymerase
* C1 (if using 12-Index I set): IL universal primer
* C1 (if using 96-index I Set A, B, C, or D): nuclease-free water
* A2: mix tube (loaded empty)
