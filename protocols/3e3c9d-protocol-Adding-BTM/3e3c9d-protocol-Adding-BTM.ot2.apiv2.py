...
metadata = {
<<<<<<< HEAD:protocols/3e3c9d-protocols-Adding-WISTD-Water/3e3c9d-protocols-Adding-WISTD-Water.ot2.apiv2.py
    'protocolName':
    'Version Update - Adding WISTD and Water to DBS 96-Well Plate ',
=======
    'protocolName': 'Version Update - Adding BTM to DBS',
>>>>>>> develop:protocols/3e3c9d-protocol-Adding-BTM/3e3c9d-protocol-Adding-BTM.ot2.apiv2.py
