# GeneRead QIAact Lung RNA Fusion UMI Panel Kit: Second Strand Synthesis
...
## Description
This protocol automates the third part of a ten part protocol for the [GeneRead QIAact Lung RNA Fusion UMI Panel Kit](https://www.qiagen.com/us/products/instruments-and-automation/genereader-system/generead-qiaact-lung-panels-ww/?catno=181936) which constructs molecularly bar-coded DNA libraries for digital sequencing. This protocol automates the Second strand synthesis part described in the [GeneRead QIAact Lung RNA Fusion UMI Panel Handbook](https://www.qiagen.com/us/resources/download.aspx?id=1a71d98a-c45c-44fa-b4af-874cd1d2b61f&lang=en).
...
![deck layout](https://opentrons-protocol-library-website.s3.amazonaws.com/custom-README-images/111210/111210-part-3.png)

### Reagent Setup

**Slot 5**: Nuclease Free Water (A1), XC Buffer (B1), RH RNase (C1), dNTP (D1), BX Enzyme (A2)
...
3. Transfer Nuclease Free Water (A1), XC Buffer (B1), RH RNase (C1), dNTP (D1), BX Enzyme (A2) to RNA samples.
4. Mix 7 times with a volume of 4 uL.
5. Centrifuge samples briefly.
6. Place PCR plate in thermocycler and incubate with the following parameters: 37°C at 7 minutes, 65°C at 10 minutes, 80°C at 10 minutes, 4°C hold indefinitely.
