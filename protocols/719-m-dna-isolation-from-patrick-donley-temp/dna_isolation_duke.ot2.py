from opentrons import instruments, labware, modules, robot
...
def run_custom_protocol(
    ...
    robot.pause("Engage magnetic module for 15 minutes, then resume.")
    ...
    robot.pause("Disengage the magnetic module")
    ...
    for cycle in range(3):
        ...
        robot.pause("Engage the magnetic module for 15 minutes.")
