...
def get_values(*names):
    import json
    _all_values = json.loads("""{"num_plates":"1","num_samp_p1":"8","num_samp_p2":"8","m300_mount":"left"}""")
...
def run(ctx):
    ...
    include_buffer_a1 = True
    include_buffer_a2 = False
    include_buffer_n3 = True
    include_moving_fresh_plate = False
    include_isoprop = False
    include_wash_buffer = True
    include_elution = False
