# rhAmpSeq Library Prep Part 2 - Cleanup 2
...
## Description
This is part 4 of a 4 part protocol for the rhAmpSeq kit. This portion performs a cleanup on the PCR amplification product. A reagent list is below:
