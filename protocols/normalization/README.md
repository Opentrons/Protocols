...
# Opentrons has launched a new Protocol Library. You should use the [new page for this protocol](https://library.opentrons.com/p/normalization). This page won’t be available after January 31st, 2024.
