...
.PHONY: parse-errors
parse-errors: xargs python protolib2/traverse_errors.py
...
parse-ot2: venvs/ot2
	...
	find protocols/ -name $(OT2_FILE_SUFFIX) | xargs python protolib2/parse/traverse_ot2.py && \
	deactivate

.PHONY: parse-README
parse-README: xargs python protolib2/traverse_README.py
