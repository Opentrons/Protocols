...
pipette_with_tips.pick_up_tip()  # picks up tip_rack_2:A1
pipette_with_tips.return_tip()
pipette_with_tips.pick_up_tip()  # picks up tip_rack_2:A2
pipette_with_tips.drop_tip()     # automatically drops in trash
