...
# Place bead plate between adapter plates and place on shaker. Shake at speed 20 for 10 minutes, turn and repeat.
...
m300.transfer(supernatantvol, bead_plate.rows('1', to='12'), collection1mL_1.rows('1', to='12'))

# Transfer 250uL of C2 to each well and apply sealing tape. Vortex for 5 seconds.
m300.transfer(250, C2, collection1mL_1.rows('1', to='12'))

# Incubate at 4C for 10 minutes.
# Centrifuge collection1mL_1 at room temperature for 6 mins at 4500 x g. Remove and discard sealing tape.

# Transfer supernatant from collection1mL_1 to new collection1mL_2. Apply sealing tape.
m300.transfer(supernatantvol, collection1mL_1.rows('1', to='12'), collection1mL_2.rows('1', to='12'))

# Centrifuge at room temperature for 6 minutes at 4500 x g.

# Transfer supernatant from collection1mL_2 to new collection1mL_3.
m300.transfer(supernatantvol, collection1mL_2.rows('1', to='12'), collection1mL_3.rows('1', to='12'))

# Transfer 200uL of C3 and apply sealing tape to collection1mL_3. Vortex for 5 seconds.
m300.transfer(200, C3, collection1mL_3.rows('1', to='12'))

# Incubate at 4C for 10 minutes.
# Centrifuge collection1mL_3 at room temperature for 6 minutes at 4500 x g. Remove and discard sealing tape.

# Transfer supernatant from collection1mL_3 to new collection1mL_4.
m300.transfer(supernatantvol, collection1mL_3.rows('1', to='12'), collection1mL_4.rows('1', to='12'))

# Apply sealing tape and centrifuge at room temperature for 6 minutes at 4500 x g.

# Transfer no more than 650uL of supernatant to new 2mL collection plate.
m300.transfer(650, collection1mL_4.rows('1', to='12'), collection2mL_1.rows('1', to='12'))

# Transfer 650uL of C4 to collection2mL_1 and add a second 650uL of C4 to collection2mL_1.
for _ in range(2):
	m300.transfer(650, C4, collection2mL_1.rows('1', to='12'))

# Remove top portion of vacuum manifold and place new 2mL collection plate in bottom of vacuum manifold.
...
# Load 650uL of samples into wells of spin plate until entire volume of each sample is processed.
for i in range(6):
...
# Discard flow through from 2mL collection plate in bottom and place it back in manifold.
# Reassemble manifold with spin plate on top and turn vacuum on. Test seal.

# Add 500uL of C5 to each well of spin plate. Turn off vacuum after entire volume has passed.
m300.transfer(500, C5_D, spin_plate('1', to='12'))

# Apply centrifuge tape to spin plate to cover all wells. Place 0.5 collection plate under spin plate.
# Centrifuge at room temperature for 6 minutes at 4500 x g.
# Place spin plate on microplate. Remove centrifuge tape and discard.
# Air dry for 10 minutes at room temperature.

# Add 100uL of C6 to center of each well of spin plate and apply centrifuge tape.
m300.transfer(100, C6, spin_plate('1', to='12'))

# Centrifuge at room temperature for 3 minutes at 4500 x g. Remove tape and discard.
